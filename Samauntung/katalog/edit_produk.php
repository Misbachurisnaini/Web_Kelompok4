<?php
    ...
    if(isset($_POST["nama"])) {
        ...
        if ($terupload) {
            ...
            if (mysqli_query($konek, $sql)){
                $sql = "UPDATE produk_detail SET harga = ".$_POST["harga"]." WHERE id_produk = ".$_GET['id'];
                if(mysqli_query($konek, $sql)){
    ...
    $sql = "SELECT produk.deskripsi_produk, produk.nama_produk, produk.id_kategori, produk_detail.harga FROM produk LEFT JOIN produk_detail ON produk.id_produk = produk_detail.id_produk WHERE produk.id_produk = ".$_GET['id'];
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <a href="home.php" style="color:black"><i class="material-icons">arrow_back</i></a>  
                <h1 class="h2" style="margin-left: 30px;">Ubah Produk</h1>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
            <a hr href="delete_produk.php?id=<?=$_GET['id']?>" style="color:red">
                <i class="material-icons" >delete</i>Hapus Produk
            </a>
          </div>
        </div>
