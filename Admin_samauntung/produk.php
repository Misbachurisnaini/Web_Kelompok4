...
include 'koneksi.php';
$query = mysqli_query($konek, "SELECT produk.gambar_produk,produk.id_produk, produk.nama_produk, kategori.nama_kategori, produk.harga, produk.stok FROM produk LEFT JOIN kategori ON produk.id_kategori = kategori.id_kategori");
?>
