...
if(isset($_POST["id_pesanan"])) {
  ...
  $namaSementara = $_FILES['no_pesanan'];
  $dirUpload = "uploads/";
  $terupload = move_uploaded_file($namaSementara, $dirUpload.$namaFile);
  if ($terupload) {
    $sql = "UPDATE pesanan 
    SET id_pesanan = ".($_POST["pesanan"]!=null?$_POST["pesanan"]:"null").",
    id_produk = '".$_POST["produk"]."',
    tanggal_terima = '".$_POST["tanggaldt"]."',
    status = '".$_POST["status"]."'
    total = '".$_POST["total"]."'
    ongkir = '".$_POST["ongkir"]."'
    alamat_lengkap = '".$_POST["alamat"]."'
    bukti_bayar = '".$_POST["bukti"]."'
    keterangan = '".$_POST["keterangan"]."'
    WHERE id_pesanan = ".$_GET['id'];
    if (mysqli_query($konek, $sql)){
      $sql = "UPDATE pesanan_detail SET jumlah = ".$_POST["qty"].", subtotal = ".$_POST["total"]." WHERE id_pesanan = ".$_GET['id'];
      if(mysqli_query($konek, $sql)){
...
$sql = "SELECT pesanan.id_produk, pesanan.tanggal_terima, pesanan.id_pesanan, pesanan.total, pesanan.ongkir, pesanan.alamat_lengkap, pesanan.bukti_bayar, pesanan.keterangan FROM pesanan LEFT JOIN pesanan_detail ON pesanan.id_pesanan = pesanan_detail.id_pesanan_detail WHERE pesanan.id_pesanan = ".$_GET['id'];
